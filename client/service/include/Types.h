...
/**
 * @struct PrismLoginParams
 * @brief 登录认证参数
 */
typedef struct PrismLoginParams {
    const char* username{nullptr};    /**< 用户名 */
    const char* password{nullptr};    /**< 密码 */
    const char* server_url{nullptr};  /**< 服务器地址 */
} PrismLoginParams;
...
/**
 * @struct PrismRoomInfo
 * @brief 当前房间的详细信息
 */
typedef struct PrismRoomInfo {
